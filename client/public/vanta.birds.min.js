!(function(e, t) {
  ...
  return (function(e) {
    ...
    1: function(e, t, i) {
      ...
      (s.register = (e, t) => (s[e] = e => new t(e))), (s.version = '0.5.11');
      const a = function() {
        return (
    ...
    17: function(e, t, i) {
      ...
      const f = function(e) {
          ((d = function(t = {}) {
          ...
          }).prototype = Object.create(e.Geometry.prototype)),
            (p = function(t) {
              var i,
                n,
                o = new e.Vector3(),
              ...
              (this.position = new e.Vector3()),
                ...
                (this.run = function(e) {
                  o.set(-r, this.position.y, this.position.z),
                    (o = this.avoid(o)).multiplyScalar(5),
                    i.add(o),
                    o.set(r, this.position.y, this.position.z),
                    (o = this.avoid(o)).multiplyScalar(5),
                    i.add(o),
                    o.set(this.position.x, -s, this.position.z),
                    (o = this.avoid(o)).multiplyScalar(5),
                    i.add(o),
                    o.set(this.position.x, s, this.position.z),
                    (o = this.avoid(o)).multiplyScalar(5),
                ...
                (this.flock = function(e) {
                  n && i.add(this.reach(n, 0.005)),
                    i.add(this.alignment(e)),
                    i.add(this.cohesion(e)),
                    i.add(this.separation(e));
                }),
                (this.move = function() {
                  this.velocity.add(i);
                ...
                (this.checkBounds = function() {
                  this.position.x > r && (this.position.x = -r),
                    this.position.x < -r && (this.position.x = r),
                ...
                (this.avoid = function(t) {
                  ...
                  return (
                    ...
                    i.sub(t),
                    i.multiplyScalar(1 / this.position.distanceToSquared(t)),
                    i
                  );
                }),
                ...
                (this.alignment = function(t) {
                  ...
                  for (var a = 0, h = t.length; a < h; a++)
                    Math.random() > 0.6 ||
                      ((n = (i = t[a]).position.distanceTo(this.position)) >
                        0 &&
                        n <= s &&
                        (o.add(i.velocity), r++));
                  if (r > 0) {
                ...
                (this.cohesion = function(t) {
                  ...
                  for (var h = 0, c = t.length; h < c; h++)
                    Math.random() > 0.6 ||
                      ((n = (i = t[h]).position.distanceTo(this.position)) >
                        0 &&
                        n <= a &&
                        (o.add(i.position), s++));
                  s > 0 && o.divideScalar(s), r.subVectors(o, this.position);
                  var u = r.length();
                  return u > 0.1 && r.divideScalar(u / 0.1), r;
                }),
                  ...
                  for (var a = 0, h = t.length; a < h; a++)
                    Math.random() > 0.6 ||
                      ((n = (i = t[a]).position.distanceTo(this.position)) >
                        0 &&
                        n <= s &&
                        (r.subVectors(this.position, i.position),
                        r.normalize(),
                        r.divideScalar(n),
                        o.add(r)));
                  return o;
            ...
            (e.BirdGeometry = function(t) {
              ...
              this.addAttribute('position', o),
                this.addAttribute('birdColor', r),
                this.addAttribute('reference', s),
                this.addAttribute('birdVertex', a);
              let c = 0;
              const u = function() {
                  for (let e = 0; e < arguments.length; e++)
                    o.array[c++] = arguments[e];
                },
                d = t.wingSpan || 20,
                p = t.birdSize || 1;
              for (let e = 0; e < h; e++)
              ...
              for (c = 0; c < 3 * i; c++) {
                const e = ~~(c / 3),
                  ...
                  o = ~~(c / 9) / h,
                  u = o.toString(),
                  d = -1 != t.colorMode.indexOf('Gradient');
                let p;
                (p = !d && f[u] ? f[u] : t.effect.getNewCol(o)),
                  d || f[u] || (f[u] = p),
                  (r.array[3 * c + 0] = p.r),
                  (r.array[3 * c + 1] = p.g),
                  (r.array[3 * c + 2] = p.b),
            ...
            (e.BirdGeometry.prototype = Object.create(
      ...
      class b extends n.b {
        ...
        initComputeRenderer() {
          ...
          w(e),
            ...
            (this.velocityUniforms.predator = { value: new s.Vector3() }),
